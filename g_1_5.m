...
for k=1:1:length(t)
    r3(k)=Xs3 * sinc((t(k) - h3*Ts3)/Ts3)';
end

    figure ('Name','Reconstructed Signal for Ts1=0.002 sec and Ts2=0.0002 sec and Ts3 = 0.02');
    ...
    plot(t, r3, '*b', 'LineWidth', 1.5, 'Color', [0.6350, 0.0780, 0.1840]);
    
    xlabel('-10 \leq t \leq +10');
    ylabel('r1(t) and r2(t) and r3(t)');
    grid on 
